...
filename = './NS_profile_'+ eos_name[0] +'.csv'
...
# data_ALF2['m']   = data_ALF2['y[1]']/M
# data_ALF2['rho'] = data_ALF2['y[0]']
# data_ALF2['r']   = data_ALF2['t']/10**5

# data_H4['m']   = data_H4['y[1]']/M
# data_H4['rho'] = data_H4['y[0]']
# data_H4['r']   = data_H4['t']/10**5

# data_MS1['m']   = data_MS1['y[1]']/M
# data_MS1['rho'] = data_MS1['y[0]']
# data_MS1['r']   = data_MS1['t']/10**5
...
plt.savefig('./MR_relation'+eos_name[0]+'.png')